  ...
  <div class="login-wrap">
    <div class="ms-login">
      ...
      <el-form :model="param"
        ...
        <p class="login-tips">Tips : domain account or admin</p>
      </el-form>
    </div>
  </div>
</template>
...
export default {
  data: function () {
    return {
      ...
      rules: {
        username: [{ required: true, message: 'Pls input username', trigger: 'blur' }],
        password: [{ required: true, message: 'Pls input passwd', trigger: 'blur' }],
      },
    };
  },
  methods: {
    submitForm () {
      this.$refs.login.validate(valid => {
        if (valid) {
          ...
          this.$message.error('Pls input your account & passwd');
